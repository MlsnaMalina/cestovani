...
export const excursions:Excursion[]=(routes as ExcursionRoute[]).flatMap(drive=>{
 ...
 return place&&drive.drivingMinutes<=100&&drive.returnMinutes<=100?[{...place,drive}]:[];
});
export const baseNames={si:'Kamniška Bistrica 8',hr:'Branimirova obala 12, Bibinje'};
export const overHour=(drive:{drivingMinutes:number;returnMinutes:number})=>drive.drivingMinutes>60||drive.returnMinutes>60;
